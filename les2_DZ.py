...
class MagnitParse:
    ...
    def __get_date(self, date_string) -> list:
        ...
        if result[0].month == 12 and result[0].month == 1 and datetime.datetime.now().month == 12:
            result[1].year += 1
        elif result[0].month == 12 and result[0].month == 1 and datetime.datetime.now().month == 1:
            result[0].year -= 1
        return result
